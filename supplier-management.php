		...
		<div class="row" style="margin">
			...
			<div class="card-block madalContent">
				...
				<div class="col-sm-8 col-md-8">
					<input type="radio" name="type" value="A" id="m_TypeT" required>
						<label for="m_TypeT">Ticket</label>
					<input type="radio" name="type" value="I" id="m_TypeD">
				...
				<div class="col-sm-12 col-md-4 header">
					Aupplier Name <font color="red">*</font>
				</div>
				<div class="col-sm-12 col-md-8">
			...
			<div class="card-block madalContent">
				...
				<div class="col-xs-8 col-sm-8 col-md-8">
					<input type="radio" name="priceType" value="Credit" id="p_TypeN" required>
						<label for="p_TypeN">Credit</label>
					<input type="radio" name="priceType" value="Deposit" id="p_TypeS">
			...
			<div class="sectionHead">Contact - Account</div>
			<div class="card-block madalContent">
				<div class="col-sm-12 col-md-4 header">
				Name <font color="red">*</font>
				</div>
